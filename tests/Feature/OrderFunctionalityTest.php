...
class OrderFunctionalityTest extends TestCase
{
    ...
    public function test_order_can_be_updated()
    {
        $compensation = Compensation::create([
            ...
            'former_plot_no' => 'FP-002',
            'rs_khatian_no' => 'RS-KH-002',
            'current_plot_no' => 'CP-002',
            'is_applicant_sa_owner' => false,
            'ownership_details' => [],
            'mutation_info' => [],
            'tax_info' => [],
    ...
    public function test_order_validation_works()
    {
        $compensation = Compensation::create([
            ...
            'former_plot_no' => 'FP-003',
            'rs_khatian_no' => 'RS-KH-003',
            'current_plot_no' => 'CP-003',
            'is_applicant_sa_owner' => false,
            'ownership_details' => [],
            'mutation_info' => [],
            'tax_info' => [],
    ...
    public function test_compensation_list_filters_by_status()
    {
        ...
        Compensation::create([
            ...
            'former_plot_no' => 'FP-PENDING',
            'rs_khatian_no' => 'RS-KH-PENDING',
            'current_plot_no' => 'CP-PENDING',
            'is_applicant_sa_owner' => false,
            'ownership_details' => [],
            'mutation_info' => [],
            'tax_info' => [],
        ...
        Compensation::create([
            ...
            'former_plot_no' => 'FP-DONE',
            'rs_khatian_no' => 'RS-KH-DONE',
            'current_plot_no' => 'CP-DONE',
            'is_applicant_sa_owner' => false,
            'ownership_details' => [],
            'mutation_info' => [],
            'tax_info' => [],
    ...
    public function test_compensation_list_search_functionality()
    {
        Compensation::create([
            ...
            'former_plot_no' => 'FP-SEARCH',
            'rs_khatian_no' => 'RS-KH-SEARCH',
            'current_plot_no' => 'CP-SEARCH',
            'is_applicant_sa_owner' => false,
            'ownership_details' => [],
            'mutation_info' => [],
            'tax_info' => [],
    ...
    public function test_pagination_works()
    {
        ...
        for ($i = 1; $i <= 15; $i++) {
            Compensation::create([
                ...
                'former_plot_no' => "FP-PAGINATION-{$i}",
                'rs_khatian_no' => "RS-KH-PAGINATION-{$i}",
                'current_plot_no' => "CP-PAGINATION-{$i}",
                'is_applicant_sa_owner' => false,
                'ownership_details' => [],
                'mutation_info' => [],
                'tax_info' => [],
