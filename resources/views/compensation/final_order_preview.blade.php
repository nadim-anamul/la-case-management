                ...
                <div class="text-justify leading-relaxed mt-4">
                              ...
                              <div class="ml-4 mt-2">
                                  ...
                                  @php
                                      ...
                                      if ($compensation->ownership_details && is_array($compensation->ownership_details) && isset($compensation->ownership_details['deed_transfers']) && count($compensation->ownership_details['deed_transfers']) > 0) {
                                          ...
                                          // If no match found by description, try to use the first available deed
                  ...
                  @if($compensation->ownership_details && is_array($compensation->ownership_details) && isset($compensation->ownership_details['applicant_info']))
                      ...
                      <div class="ml-4 mt-2">
                          ...
                          <strong>খাজনার বর্ণনা:</strong> দাখিলকৃত খাজনার রশিদ যাচাই করে দেখা যায়, {{ $paidInName }} নামে {{ $compensation->bnDigits($holdingNo) }} নং হোল্ডিং এ {{ $compensation->bnDigits($kharijPlotNo) }} নং দাগে {{ $compensation->bnDigits($paidLandAmount) }} একর জমির বিপরীতে বাংলা {{ $compensation->bnDigits($banglaYear) }} সন/ ইংরেজি {{ $compensation->bnDigits($englishYear) }} সাল পর্যন্ত ভূমি উন্নয়ন কর পরিশোধ অন্তে খাজনার রশিদ দাখিল করা হয়েছে।<br><br>
                  ...
                  <br><br>
                  <strong>কানুনগো ও সার্ভেয়ারের মতামতঃ</strong> দাখিলকৃত কাগজপত্র যাচাইপূর্বক কানুনুনগো ও সার্ভেয়ারগণের দাখিলকৃত প্রতিবেদনে উল্লেখ করা হয় যে আবেদনকারী মালিকানার দাবীর স্বপক্ষে কাগজপত্রের ধারাবাহিকতা আছে।
                  ...
                  <table class="w-full border border-black border-collapse mb-4">
                      ...
                      <tbody>
                          ...
                          <!-- Total Row -->
                          @php
                              // Calculate source tax and final amount after total is computed
