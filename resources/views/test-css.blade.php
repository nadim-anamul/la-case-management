            ...
            <div class="relative">
                ...
                <div class="relative flex justify-between items-center">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative">
                            <!-- Step Circle -->
                            <div class="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold cursor-pointer transition-all duration-300 hover:scale-110 bg-green-500 text-white shadow-md relative">
                                <span>১</span>
                                
                                <!-- Small Check Icon for Completed Steps -->
                                <svg class="absolute -top-1 -right-1 w-4 h-4 bg-green-500 text-white rounded-full p-0.5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative">
                            <!-- Step Circle -->
                            <div class="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold cursor-pointer transition-all duration-300 hover:scale-110 bg-blue-500 text-white shadow-lg ring-2 ring-blue-300 relative">
                                <span>২</span>
                            </div>
                        </div>
