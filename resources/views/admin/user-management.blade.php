...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if (session('success'))
            <div id="successMessage" class="bg-green-50 border border-green-200 text-green-700 px-6 py-4 rounded-xl mb-6 transition-all duration-300">
                {{ session('success') }}
            </div>
        @endif

        @if (session('error'))
            <div id="errorMessage" class="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-xl mb-6 transition-all duration-300">
                {{ session('error') }}
            </div>
        @endif
