...
class CompensationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'ownership_details.inheritance_records.*.is_heir_applicant' => 'nullable|in:yes,no',
            ...
            'kanungo_opinion.document_deficiency' => 'required|in:yes,no',
            'kanungo_opinion.opinion_details' => 'nullable|string',
            'kanungo_opinion.special_comments' => 'nullable|string',
        ]);
